...
public class SingleLinkedList<E> {
		...
		public static void exercise() {
	    	...
	    	SingleLinkedList KWSingleLinkedList = new SingleLinkedList();
			KWSingleLinkedList.add("Tom");
			KWSingleLinkedList.add("Dick");
			KWSingleLinkedList.add("Harry");
			KWSingleLinkedList.add("Sam");

			// a
			KWSingleLinkedList.addFirst("Bill");

			// b
			KWSingleLinkedList.addAfter(KWSingleLinkedList.getNode(3),"Sue");

			// c
			KWSingleLinkedList.removeFirst();

			// d
			KWSingleLinkedList.remove(4);
		}
}
